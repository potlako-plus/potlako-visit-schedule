...
crfs_followup = FormsCollection(
    Crf(show_order=1, model='potlako_subject.patientcallfollowup'),
    Crf(show_order=2, model='potlako_subject.cancerdiagnosisandtreatmentassessment'),
    Crf(show_order=3, model='potlako_subject.investigationsordered', required=False),
    Crf(show_order=4, model='potlako_subject.investigationsresulted', required=False),
    Crf(show_order=5, model='potlako_subject.missedvisit', required=False),
    name='followup',
)
